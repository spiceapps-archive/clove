package com.cloveHello.plugin.column.controller
{
	...
	import com.cloveHello.plugin.postables.HelloPostable;
	...
	public class HelloCloveColumnController extends ColumnController
	{
		...
		{
			super.onRenderedDataDoubleClick(event);
			
			var rcd:RenderedColumnData = RenderedColumnData(event.data);
			
			this.addActivePostable(new HelloPostable(this.pluginController,"Rendered Data - "+rcd.rowuid));
		}
