package com.spice.air.collections
{
	...
	import com.spice.clove.plugin.core.root.ColumnSQLHistory;
	import com.spice.recycle.JanitorManager;
...
//				trace(_previousIndex,newPage);
				
				if(_previousIndex == newPage)
				{
					//trace("FDSLSD",this._previousList.length-1-currentIndex);
			...
			trace(index,currentIndex,newPage,_index,this._bufferSize,this._currentStack.length);
        ...
        public function removeAll():void
        {
        	...
        	trace("SQLList::removing all items");
