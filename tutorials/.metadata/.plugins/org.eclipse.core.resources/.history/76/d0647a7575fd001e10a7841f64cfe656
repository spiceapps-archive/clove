...
{
	import com.cloveHello.plugin.column.controller.HelloColumnController;
	...
	public class CloveHelloPlugin extends ClovePlugin
	{
		...
		override public function initialize(controller:IPluginController):void
		{
			...
			this.addAvailableColumnController(new ColumnControllerFactory("Hello Column",controller,HelloColumnController));
