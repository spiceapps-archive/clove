package com.architectd.twitter2.responseHandler
{
	...
	public class TwitterJSONSingleStatusResponse extends TwitterJSONResponseHandler
	{
		...
		public function TwitterJSONSingleStatusResponse()
		{
		}
		...
		override protected function getData(res:Object):*
		{
