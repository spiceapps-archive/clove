package com.spice.clove.plugin.youtube.impl.content.control.search
{
	...
	public class CloveYoutubeSearchVideoContentController extends CloveYoutubeSearchBasedContentController
	{
		//--------------------------------------------------------------------------
		//
		//  Private Variables
		...
		/**
		 */
		public function CloveYoutubeSearchVideoContentController(name:String,
		...
		override protected function loadNewer2(data:ICloveData=null):void
		{
			...
			_plugin.getConnection().search(this.getSearchTerm().getData()).addEventListener(ServiceEvent.RESULT,onSearchResult);
		}
