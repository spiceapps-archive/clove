<?php
	...
	*/
	...
	$amfDir = dirname(__FILE__)."/../library/amfphp/";
	
	//Include things that need to be global, for integrating with other frameworks
	include "$amfDir/globals.php";

	//Include framework
	include $amfDir."core/amf/app/Gateway.php";

	$gateway = new Gateway();
	
	//echo dirname(__FILE__)."/apps/$app/services/";
	
	//Set where the services classes are loaded from, *with trailing slash*
	//$servicesPath defined in globals.php
	$gateway->setClassPath(dirname(__FILE__)."/../apps/$app/services/public/");
